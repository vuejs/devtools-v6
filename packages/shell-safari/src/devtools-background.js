...
browser.devtools.network.onNavigated.addListener(createPanelIfHasVue)
...
function onPanelShown () {
  browser.runtime.sendMessage('vue-panel-shown')
}

function onPanelHidden () {
  browser.runtime.sendMessage('vue-panel-hidden')
}
